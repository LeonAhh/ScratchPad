...
final class ScratchPadApp: NSObject, NSApplicationDelegate, NSWindowDelegate, NSTextViewDelegate, NSMenuDelegate {
    private let initialText: String

    private var window: NSWindow?
    private var rootView: NSVisualEffectView?
    private var scrollView: NSScrollView?
    private var textView: ScratchPadTextView?
...
let delegate = ScratchPadApp(initialText: readLaunchText())
